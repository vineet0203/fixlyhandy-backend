    ...
    public function handle()
    {
        ...
        $deploymentData = [
            ...
            'commit' => [
                ...
                'url' => 'https://github.com/rajpootsourabh/fixlyhandy-backend/commit/cc172706f35a0991e02bad68847c4b72758ef6a8',
            ],
            'repository' => [
                'name' => 'rajpootsourabh/fixlyhandy-backend',
                'url' => 'https://github.com/rajpootsourabh/fixlyhandy-backend',
            ],
