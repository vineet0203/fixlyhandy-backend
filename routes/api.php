...
Route::prefix('public')->group(function () {
    Route::get('service-categories', 'App\Http\Controllers\Api\V1\Public\ServiceCategoryController@index');
    Route::get('service-sub-categories', 'App\Http\Controllers\Api\V1\Public\ServiceSubCategoryController@index');
    Route::get('services', 'App\Http\Controllers\Api\V1\Public\ServiceController@index');
});
